...
MODEL_NAME = 'w_s_clusters_4'

DATA = 'welcome_survey_simple_v2.csv'

CLUSTER_NAMES_AND_DESCRIPTIONS = 'welcome_survey_cluster_names_and_descriptions.json'
...
image = Image.open(f"{predicted_cluster_id}.jpeg")
st.image(image, caption="Wygenerowane przez AI Freepik", use_container_width=True)
